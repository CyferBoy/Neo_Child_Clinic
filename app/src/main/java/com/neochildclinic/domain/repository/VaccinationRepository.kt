...
// starts reading items outside the data layer. The vaccination card projection
// (PatientVaccinationCardEntity) is likewise a read-only DB join consumed verbatim by the
